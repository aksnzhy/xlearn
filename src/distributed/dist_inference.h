...
#ifndef XLEARN_SOLVER_DIST_INFERENCE_H_
#define XLEARN_SOLVER_DIST_INFERENCE_H_
...
class DistPredictor {
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(DistPredictor);
};  // class Predictor

}  // namespace xLearn

#endif // XLEARN_SOLVER_DIST_INFERENCE_H_
