...
#ifndef XLEARN_LOSS_DIST_SQUARED_LOSS_H_
#define XLEARN_LOSS_DIST_SQUARED_LOSS_H_
...
//------------------------------------------------------------------------------
class DistSquaredLoss : public Loss {
 public:
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(DistSquaredLoss);
};

} // namespace xLearn

#endif // XLEARN_LOSS_DIST_SQUARED_LOSS_H_
