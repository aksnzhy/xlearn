...
real_t FMScore::CalcScoreFtrl(const SparseRow* row,
                          Model& model,
                          real_t norm) {
  /*********************************************************
...
// Using SSE to accelerate vector operation.
void FMScore::CalcGradFtrl(const SparseRow* row,
                       Model& model,
                       real_t pg,
                       real_t norm) {
  /*********************************************************
